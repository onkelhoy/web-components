...
a minimal html parser for node that exposes the core set of functionalities regular document DOM exposes

---

![Type](https://img.shields.io/badge/Type-runtime-orange)
[![Tests](https://github.com/onkelhoy/web-components/actions/workflows/pull-request.yml/badge.svg)](https://github.com/onkelhoy/web-components/actions/workflows/pull-request.yml)
[![NPM version](https://img.shields.io/npm/v/@papit/node-html.svg?logo=npm)](https://www.npmjs.com/package/@papit/node-html)
